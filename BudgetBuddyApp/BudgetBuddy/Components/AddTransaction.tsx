...
export default function AddTransaction({
  ...
  const [categories, setCategories] = useState<Category[] | void>([]);
  ...
  async function getExpenseType(currentTab: number) {
    ...
    const result = await db.getAllAsync<Category>(
      ...
      console.log("Selecting categories Error!");
...
function CategoryButton({
  ...
  return (
    ...
    >
      <Text style={{ fontWeight: "700", color: isSelected ? "#007BFF20" : "#000000", marginLeft: 5 }}>
        {title}
      </Text>
    </TouchableOpacity>
  );
